...
parser.add_argument('--dataroot', type=str, default='../data/small_splits/train', help='path to dataset')
...
content_criterion = LqLoss(q=0.8, eps=7, cuda_enabled=opt.cuda) #eps range 1~10 or 20
